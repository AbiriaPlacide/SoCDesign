	soc_system u0 (
		...
		.port_baudrate                         (<connected-to-port_baudrate>),                         //                      port.baudrate
		.port_spi_cs0                          (<connected-to-port_spi_cs0>),                          //                          .spi_cs0
		.port_spi_cs1                          (<connected-to-port_spi_cs1>),                          //                          .spi_cs1
		.port_spi_cs2                          (<connected-to-port_spi_cs2>),                          //                          .spi_cs2
		.port_spi_cs3                          (<connected-to-port_spi_cs3>),                          //                          .spi_cs3
		.port_spi_rx                           (<connected-to-port_spi_rx>),                           //                          .spi_rx
		.port_spi_tx                           (<connected-to-port_spi_tx>)                            //                          .spi_tx
	);
